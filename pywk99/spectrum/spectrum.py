...
def get_power_spectrum(
        ...
        taper_alpha: Optional[float] = 0.5) -> xr.DataArray:
    """
    ...
    power_spectrum = get_spectrum(
        "power", variable, component_type, data_frequency, window_length,
        overlap_length, season, min_periods_season, taper_alpha)
...
def get_amplitude_spectrum(
    ...
    amplitude_spectrum = get_spectrum(
        "amplitude", variable, component_type, data_frequency, window_length,
        overlap_length, season, min_periods_season, taper_alpha)
...
def get_cross_spectrum(
    ...
    cross_spectrum = get_spectrum(
        "cross", variable, component_type, data_frequency, window_length,
        overlap_length, season, min_periods_season, taper_alpha)
